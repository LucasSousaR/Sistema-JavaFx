...
CREATE TABLE public."procedimentoProfissiona" (
    in_pv_id  serial not null,
    in_pv_id_procedimentoEstetico integer not null,
    in_pv_id_proficionalEstetico integer not null,
    
    
    CONSTRAINT "procedimentoProfissiona_pkey" PRIMARY KEY ("in_pv_id"),
    CONSTRAINT "FK_in_pv_id_procedimentoEstetico" FOREIGN KEY ("in_pv_id_procedimentoEstetico"),
			REFERENCES public."procedimentoEstetico" ("in_pv_id") 
	CONSTRAINT "FK_in_pv_id_proficionalEstetico" FOREIGN KEY ("in_pv_id_proficionalEstetico")
			REFERENCES public."proficionalEstetico" ("in_pv_id") 
...
CREATE TABLE public."diaAgendado" (
    ...
    in_pv_id  serial not null,
    dt_pv_data date  not null,
    tm_pv_hora time not null,
    in_pv_id_cliente integer not null,
    in_pv_id_procedimentoEstetico integer not null,
    in_pv_id_proficionalEstetico integer not null,
